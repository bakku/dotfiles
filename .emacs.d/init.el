...
(custom-set-variables
 ...
 '(package-selected-packages
   '(company lsp-mode web-mode gruvbox-theme general evil-collection magit doom-modeline markdown-mode exec-path-from-shell cider parinfer clojure-mode flycheck-clj-kondo flycheck rainbow-delimiters projectile org-bullets smex which-key key-chord counsel evil)))
